...
public class DBHelper extends SQLiteOpenHelper {
    ...
    {
        try //called by getListing to retrieve a listing stored in an SQLite table
        {
    ...
    private byte[] writeAccount(account myAccount)//convert a listing to a byte array, or blob,
    {   //called by addListing to store a listing in an SQLite table
        try {
            ByteArrayOutputStream bos = new ByteArrayOutputStream();
    ...
    private account readAccount(byte[] myBlob)  //convert a byte array or blob into a listing
    {
        try //called by getListing to retrieve a listing stored in an SQLite table
        {
            ByteArrayInputStream bis = new ByteArrayInputStream(myBlob);
...
public class myDBHelper
{
    ...
    public void writeListing(listing myListing)
    {
        try {
//            File.createTempFile("templisting", "txt");
  //          FileOutputStream myFile = new FileOutputStream("templisting.txt");
    //        ObjectOutputStream out = new ObjectOutputStream(myFile);
          ...
          //  out.writeObject(myListing);
            ...
            objectOutputStream.writeObject(myListing);
